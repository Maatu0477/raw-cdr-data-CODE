...
# write the logic of loading the data
def load_data():
    
  print("Start of the load_data functtion")

  #variable by default are local variable. 
...
# Flow of your Project (Main code section)
def main():
    load_data()
